...
export const COMPARE_PAGES: Record<string, ComparePage> = {
  ...
  "gravyblock-vs-bulletproof": {
    ...
    model: {
      ...
      sections: [
        ...
        {
          title: "What GravyBlock does differently",
          body: "GravyBlock handles GBP content publishing, citation audits, review monitoring with AI reply drafts, visibility score tracking, and monthly digests automatically. Works for real estate agents and any other local business, starting at $29.99/month introductory.",
          bullets: [
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Starts free with a scan. Paid plans from $29.99/month introductory.",
          ],
        },
      ],
      relatedLinks: [
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Starts free. Autopilot plans from $29.99/month introductory.",
          ],
        },
      ],
      relatedLinks: [
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Free scan in 60 seconds. Starts at $29.99/mo with code INTRO50.",
          ],
        },
      ],
      relatedLinks: [
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Free scan shows your gaps in 60 seconds. Starts at $29.99/mo with INTRO50.",
          ],
        },
      ],
      relatedLinks: [
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "No data science degree required. Starts at $29.99/mo with code INTRO50.",
          ],
        },
      ],
      relatedLinks: [
  ...
  "gravyblock-vs-reputation": {
    ...
    metaDescription: "Reputation.com is an enterprise platform starting at $500+/month with annual contracts. GravyBlock delivers automated content, reviews, citations, and AI visibility monitoring from $29.99/month with no contract.",
    model: {
      ...
      sections: [
        ...
        {
          title: "What GravyBlock does differently",
          body: "GravyBlock combines reputation management with proactive local SEO and AI-era visibility features that Reputation.com does not offer at any price tier. It starts with a free 60-second scan, requires no sales call, and runs on a month-to-month basis from $29.99/month.",
          bullets: [
