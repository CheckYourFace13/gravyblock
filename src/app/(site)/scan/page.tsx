    ...
    <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
      ...
      {selectedPlan ? (
        <div className="mx-auto mt-6 max-w-3xl rounded-2xl border border-red-200 bg-red-50/70 p-4 text-sm text-zinc-900">
          <p className="font-semibold">{selectedPlan === "base" ? "Basic selected" : "Pro selected"}</p>
          <p className="mt-1 text-zinc-700">
            Confirm the right Google listing so we can attach {selectedPlan === "base" ? "Basic" : "Pro"} to this business
