  ...
  return (
    <VerticalLanding
      ...
      bullets={[
        ...
        "Build review count on Google — the single biggest ranking factor for local plumbing searches.",
        "Send backlink outreach to local home improvement, real estate, and neighborhood content sites.",
        "Track AI visibility for home emergency searches — more homeowners ask ChatGPT first.",
      ]}
      ctaHref="/scan"
